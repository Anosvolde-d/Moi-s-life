...
const config = {
    discord: {
        userId: 'YOUR_DISCORD_USER_ID', // Replace with your Discord user ID
    ...
    music: {
        src: 'path/to/your/song.mp3', // Replace with your music file path
        autoplay: true,
        volume: 0.3
    },
    vscode: {
...
class DiscordStatusManager {
    ...
    handleDiscordClick() {
        ...
        showToast('Discord: anos#1234');
        // Or copy Discord tag to clipboard
        this.copyToClipboard('anos#1234');
    }
...
class AnimationManager {
    ...
    initScrollAnimations() {
        ...
        const animatedElements = document.querySelectorAll('.skill-card, .project-card, .contact-info, .contact-form');
